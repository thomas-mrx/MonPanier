...
class Recall(models.Model):
    ...
    nom_de_la_marque_du_produit = models.CharField(max_length=256, blank=True, null=True)
    noms_des_modeles_ou_references = models.CharField(max_length=512, blank=True, null=True)
    identification_des_produits = models.CharField(max_length=4096, blank=True, null=True)
    ean = models.CharField(max_length=16, blank=True, null=True)
    conditionnements = models.CharField(max_length=256, blank=True, null=True)
    ...
    marque_de_salubrite = models.CharField(max_length=256, blank=True, null=True)
    informations_complementaires = models.CharField(max_length=2048, blank=True, null=True)
    zone_geographique_de_vente = models.CharField(max_length=2048, blank=True, null=True)
    distributeurs = models.CharField(max_length=512, blank=True, null=True)
    motif_du_rappel = models.CharField(max_length=2048, blank=True, null=True)
    risques_encourus_par_le_consommateur = models.CharField(max_length=256, blank=True, null=True)
    preconisations_sanitaires = models.CharField(max_length=4096, blank=True, null=True)
    description_complementaire_du_risque = models.CharField(max_length=256, blank=True, null=True)
    conduites_a_tenir_par_le_consommateur = models.CharField(max_length=256, blank=True, null=True)
    ...
    informations_complementaires_publiques = models.CharField(max_length=256, blank=True, null=True)
    liens_vers_les_images = models.CharField(max_length=512, blank=True, null=True)
